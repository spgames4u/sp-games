...
(function() {
    ...
    function getGameSlug() {
        ...
        return parts[parts.length - 1] || 'master-chess';
    }
    ...
    window.__ctlArcadeSaveScore = function(s) {
        console.log('%c♔ Chess score saved: ' + s, 'color: #795548; font-weight: bold');
    };
    ...
    function newCtlArcadeSaveScore(iScore) {
        ...
        if (!fromGame) {
            console.log('%c♔ Chess score saved: ' + iScore, 'color: #795548; font-weight: bold');
            return;
        }
