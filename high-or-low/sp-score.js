...
(function() {
    ...
    const guardKey = '__SP_SCORE_RUNNING_' + (
        ...
        || (() => {
            ...
            return parts[parts.length - 1] || 'high-or-low';
        })()
    );
    if (window[guardKey]) {
    ...
    window.__ctlArcadeSaveScore = function(s) {
        ...
        console.log('%c[SP-Score] ✅ Score saved!', 'color: #00c853; font-weight: bold', { ok: true, newHighScore: true, score: raw });
    };
    ...
    function newCtlArcadeSaveScore(iScore) {
        ...
        if (!fromGame) {
            console.log('%c[SP-Score] ✅ Score saved!', 'color: #00c853; font-weight: bold', { ok: true, newHighScore: true, score: iScore });
            return;
        }
