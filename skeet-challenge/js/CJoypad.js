function CJoypad(oSprite, iX, iY, oParentContainer, bFixedPosition){
	...
	var _iPreventDoubleTap = new Date().getTime();
    ...
    this._init = function(oSprite, iX, iY, oParentContainer, bFixedPosition){
        ...
        oParentContainer.addEventListener('mousedown', this.onPressStart);
        oParentContainer.addEventListener('pressmove', this.onPressMove);
        oParentContainer.addEventListener('pressup', this.onPressRelease);
    ...
    this.unload = function(){
        ...
        oParentContainer.removeEventListener('mousedown', this.onPressStart);
        oParentContainer.removeEventListener('pressmove', this.onPressMove);
        oParentContainer.removeEventListener('pressup', this.onPressRelease);
    ...
    this.onPressStart = function(evt){
  			 ...
  			 if(evt.stageX < CANVAS_WIDTH/2){
				...
				if ( (iCurTime -_iPreventDoubleTap) > 1000 ){
					_iPreventDoubleTap = iCurTime;	
