...
(function() {
    ...
    function getGameSlug() {
        ...
        return parts[parts.length - 1] || 'skeet-challenge';
    }
    ...
    window.__ctlArcadeSaveScore = function(s) {
        console.log('%c🎯 Skeet score saved: ' + s, 'color: #795548; font-weight: bold');
    };
    ...
    function newCtlArcadeSaveScore(iScore) {
        ...
        if (!fromGame) {
            console.log('%c🎯 Skeet score saved: ' + iScore, 'color: #795548; font-weight: bold');
            return;
        }
