function CEndPanel(oSpriteBg){
    ...
    this._init = function(oSpriteBg){
        ...
        _oMsgTextBack = new createjs.Text("","80px "+FONT_GAME, "#000");
        _oMsgTextBack.x = CANVAS_WIDTH/2 +2;
        _oMsgTextBack.y = (CANVAS_HEIGHT/2)-98;
        _oMsgTextBack.textAlign = "center";

        _oMsgText = new createjs.Text("","80px "+FONT_GAME, "#ffffff");
        ...
        _oScoreText = new createjs.Text("","60px "+FONT_GAME, "#ffffff");
