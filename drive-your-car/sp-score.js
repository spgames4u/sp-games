...
(function() {
    ...
    const gameSlugFallback = (() => {
        ...
        return new URLSearchParams(location.search).get('gameSlug') || parts[parts.length - 1] || 'drive-your-car';
    })();
    ...
    window.__ctlArcadeSaveScore = function(arg) {
        ...
        console.log('%c✅ Great run! Score saved: ' + raw, 'color: #00c853; font-weight: bold');
    };

    window.SP_SAVE_SCORE = function(iScore) {
        processScore(iScore);
    };
