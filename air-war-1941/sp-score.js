...
(function() {
    ...
    function startTracking() {
        ...
        if (window.parent !== window) {
            const allowedOrigins = ['http://localhost:4000', 'http://127.0.0.1:4000', 'https://sp.games', 'https://sp.games', 'https://games.sp.games'];
    ...
    function handleScore(arg) {
        const stack = new Error().stack || '';
        const fromGame = stack.includes('c3runtime') || stack.includes('scriptsInEvents');
